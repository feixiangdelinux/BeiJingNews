...
public class NewsCenterPager extends BasePager {
	...
	public void switchePager(int position) {
		...
		//当切换到图组详情页面的时候，显示按钮，其他地方都隐藏
		if(position==2){
			
			ib_base_switch_list_grid.setVisibility(View.VISIBLE);
			
			ib_base_switch_list_grid.setOnClickListener(new OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					
					PhotosMenuDetailPager detailPager = (PhotosMenuDetailPager) menuBasePagers.get(2);
					detailPager.switcheListAndGrid(ib_base_switch_list_grid);
